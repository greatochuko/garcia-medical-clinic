...
class PrescriptionController extends Controller
{
    public function print($id, $app_id): Response
    {
        ...
        $doctor = User::leftJoin('doctors', 'users.id', '=', 'doctors.user_id')
            ...
            ->select('users.first_name as doctor_name', 'users.middle_initial as doctor_middle_initial', 'users.last_name as doctor_last_name', 'doctors.license_number', 'doctors.ptr_number')
            ->first();
