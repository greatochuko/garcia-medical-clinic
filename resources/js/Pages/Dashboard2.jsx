...
export default function Dashboard({
    ...
    return (
        ...
        >
            ...
            <div className="max-w-8xl mx-auto py-3 sm:px-6 lg:px-8">
                <div className="">
                    <div className="bg-blue overflow-hidden p-0 shadow-sm sm:rounded-lg">
                        ...
                        >
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-6 flex gap-4">
                                    <div className="flex flex-1 items-center justify-between rounded-lg bg-[#6BC2E6] p-6 text-white shadow">
                                        <div>
                                            <div className="text-3xl font-bold">
                                                {todaysummary.total_patients}
                                            </div>
                                    ...
                                    <div className="flex flex-1 items-center justify-between rounded-lg bg-[#6BC2E6] p-4 text-white shadow">
                                        <div>
                                            <div className="text-3xl font-bold">
                                                {
                                                    todaysummary.total_appointments
                                                }
                                            </div>
                                            <div className="text-xs font-bold opacity-90">
                                                APPOINTMENTS
                                ...
                                <div className="flex-grow rounded-lg bg-white p-4">
                                    ...
                                    <div className="mb-6 pr-3">
                                        <h3
                                            className="sticky top-0 z-10 mb-3 bg-white text-lg font-semibold"
                                            style={{
                                                fontFamily:
                                                    "Poppins, sans-serif",
                                                fontWeight: 400,
                                        ...
                                        ></div>
                                        <div className="patient-template min-h-[200px] space-y-3">
                                            {waitingpatients.map(
                                                (patient, index) => (
                                                    <div
                                                        key={index}
                                                        className="flex items-center border border-blue-200 bg-blue-50 shadow-sm transition hover:bg-blue-50"
                                                        style={{
                                                            fontFamily:
                                                                "Poppins, sans-serif",
                                                            fontWeight: 400,
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center justify-center pr-2">
                                                            <span
                                                                style={{
                                                                    ...
                                                                    alignItems:
                                                                        "center",
                                                                    color: patient.queue_type.startsWith(
                                                                        "S",
                                                                    )
                                                                        ? "#FF8000"
                                                                        : "#429ABF",
                                                        ...
                                                        />
                                                        {/* Patient Info */}
                                                        <div className="min-w-0 flex-1 pl-2 leading-[18px]">
                                                            <span
                                                                style={{
                                                                    fontFamily:
                                                                        "Poppins, sans-serif",
                                                                ...
                                                                className="block truncate text-base text-gray-800"
                                                            >
                                                                {
                                                                    patient.first_name
                                                                }{" "}
                                                            ...
                                                            <div className="mt-0.5 font-poppins text-[12px] font-normal leading-[16px] text-[#666666]">
                                                                {
                                                        ...
                                                        {/* Actions */}
                                                        <div
                                                            className="ml-2 flex flex-row items-center gap-1 px-2"
                                                            style={{
                                                                background:
                                                                    "#FFFFFF",
                                                                borderRadius:
                                        ...
                                        <div className="sticky bottom-0 mt-4 flex justify-end bg-white">
                                            <NavLink
                                                href="/appointment-manager"
                                                className="text-sm font-medium text-[#429ABF] transition-colors hover:text-[#2D7A9C]"
                                            >
                                                See All &gt;&gt;
                                            </NavLink>
                                        </div>
                                    ...
                                    <div className="pr-3">
                                        ...
                                        ></div>
                                        <div className="patient-template-2 min-h-[200px] space-y-3">
                                            {pendingpatients.map(
                                                (patient, index) => (
                                                    <div
                                                        key={index}
                            ...
                            <div className="flex h-full flex-col space-y-6">
                                <div className="flex-grow rounded-lg bg-[#F8FDFF] p-6">
                                    <h3 className="mb-4 text-[14px] font-normal text-[#429ABF]">
                                        MONTHLY CALENDAR
                                    </h3>
                                    <div
                                        style={{
                                    ...
                                    ></div>
                                    <div className="mb-4 flex items-center justify-between text-[14px] font-normal text-[#429ABF]">
                                        <button
                                    ...
                                    <div className="grid grid-cols-7 rounded-t-lg bg-[#EAF7FC] py-2 text-center">
                                        {weekdays.map((day) => (
                                            <div
                                                key={day}
                                    ...
                                    <div className="mt-4 grid grid-cols-7 gap-1 bg-[#EAF7FC] text-center">
                                                    ...
                                                    day === null
                                                        ...
                                                        : `p-2 ${
                                                              isToday(
                                                                  ...
                                                                  ? "mx-auto flex h-8 w-8 items-center justify-center rounded-lg bg-[#6BC2E6] text-white"
                                                                  : "text-[#666666]"
                                                          }`
                                                }
                                            >
                                ...
                                <div className="flex-grow rounded-lg bg-white p-4">
                                    ...
                                    >
                                        {remindercurrents.map(
                                            (reminder, index) => (
                                                <div
                                                    key={index}
                                                    className="rounded-lg bg-gray-100 p-2 text-[#666666] shadow-sm"
                                                >
                            ...
                            <div className="flex h-full flex-col space-y-6">
                                ...
                                <div className="rounded-lg bg-[#6BC2E6] p-2 text-center text-white shadow">
                                    {/* Current Patient */}
                                    <div className="mb-0 flex items-center justify-center">
                                        <div
                                            style={{
                                                ...
                                                letterSpacing: "-1px",
                                                lineHeight: "1",
                                                color: queueData?.current_patient?.startsWith(
                                                    "R",
                                                )
                                                    ? "#FFFFFF"
                                                    : "#FF8000",
                                    ...
                                    <div className="mt-2 flex items-center justify-between">
                                        {/* PREV */}
                                        <div
                                            className="ml-4 flex translate-y-[-8px] flex-col items-center leading-tight"
                                            style={{
                                                fontFamily:
                                                    "Poppins, sans-serif",
                                                fontWeight: 700,
                                        ...
                                        >
                                            <span
                                                style={{
                                                    color: queueData?.previous_patient?.startsWith(
                                                        "R",
                                                    )
                                                        ? "#FFFFFF"
                                                        : "#FF8000",
                                        ...
                                        {/* NEXT */}
                                        <div
                                            className="mr-4 flex translate-y-[-8px] flex-col items-center leading-tight"
                                            style={{
                                                fontFamily:
                                                    "Poppins, sans-serif",
                                                fontWeight: 700,
                                        ...
                                        >
                                            <span
                                                style={{
                                                    color: queueData?.next_patient?.startsWith(
                                                        "R",
                                                    )
                                                        ? "#FFFFFF"
                                                        : "#FF8000",
                                                        ...
                                                        <div className="flex items-center justify-center pr-2">
                                                            <span
                                                                style={{
                                                                    ...
                                                                    alignItems:
                                                                        "center",
                                                                    color: item.queue_type.startsWith(
                                                                        "S",
                                                                    )
                                                                        ? "#FF8000"
                                                                        : "#429ABF",
                                ...
                                <div className="flex-grow rounded-lg bg-white p-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="relative h-8 w-[100%]">
                                                <div className="absolute left-0 top-0 flex h-8 w-full items-center rounded-xl bg-[#DA3D22]">
                                                    <span className="ml-4 text-sm font-bold text-white">
                                                        {
                                                            todayactivities.unfinished_docs
                                                        }
                                                    </span>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="relative h-8 w-[100%]">
                                                ...
                                                <div
                                                    className="absolute right-0 top-0 h-8 rounded-xl bg-[#6BC2E6]"
                                                    style={{
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="relative h-8 w-[100%]">
                                                <div className="absolute left-0 top-0 h-8 w-full rounded-xl bg-[#CACACA]"></div>
                                                <div
                                                    className="absolute left-0 top-0 h-8 rounded-xl bg-[#6BC2E6]"
                                                    style={{
