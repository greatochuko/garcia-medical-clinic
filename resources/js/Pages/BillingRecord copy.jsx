        ...
        >
            ...
            <div className="py-3">
                <div className="max-w-8xl main-screen mx-8 bg-white">
                    <div
                        className="m-0 border-b-[5px] border-[#E9F9FF] bg-white pb-6 pt-4 pt-6 text-center"
                        style={{ color: "#429ABF", fontWeight: 800 }}
                    >
                        BILLING RECORD
                    </div>
                    <div className="mb-3 mt-4 flex justify-between px-4 py-4">
                                ...
                                {patient.data.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <div className="text-sm text-gray-500">
                                                {item.paid == "true" ? (
                                                    <span className="rounded bg-[#B3E9CA] px-4 py-1 text-[#1B7E45]">
                                                        Paid
                                                    </span>
                                                ) : (
                                                    <span className="rounded bg-[#FECACA] px-4 py-1 text-[#B91C1C]">
                                                        Unpaid
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <div className="text-sm text-gray-500">
                                                ...
                                                {activeActionRow === index && (
                                                    <div className="absolute right-[120px] z-10 mt-0 w-32 rounded-[5px] border border-gray-200 bg-white shadow-lg">
                                                        <button
                                                            type="button"
                                                            className="block w-full px-4 py-2 text-center text-[14px] text-gray-700 transition-colors hover:bg-[#CDCDCD]"
                                                            onClick={() =>
                                                                handleDeleteClick(
                                                                    item.id,
                                                                )
