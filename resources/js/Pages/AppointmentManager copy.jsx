...
export default function AppointmentManager({ auth, appointments }) {
    ...
    const handleDelete = () => {
        router.delete(
            route("appointments.destroy.active", selectedAppointment.id),
            {
                onSuccess: () => {
    ...
    const handlePerPageChange = (e) => {
        ...
        router.get(
            route("appointments.index", { perPage: newPerPage, page: 1 }),
        );
    };
    ...
    const onDragEnd = (result) => {
        ...
        const direction =
            result.source.index > result.destination.index ? "up" : "down";

        // Store the original item at destination before any splicing
        const originalDestinationItem =
            direction === "down" ? items[result.destination.index] : null;
        ...
        router.post(
            route("appointments.reorder"),
            {
                reorderData: {
                    id: draggedItem.id,
                    draggedOrderNumber: draggedItem.order_number,
                    replacedOrderNumber: replacedItem
                        ? replacedItem.order_number
                        : null,
                    direction: direction,
                },
            },
    ...
    return (
        ...
        >
            ...
            <div className="py-3">
                <div className="max-w-8xl main-screen mx-8 bg-white">
                    <div
                        className="m-0 border-b-[5px] border-[#E9F9FF] pb-6 pt-6 text-center"
                    ...
                    <div className="appointment-manager-table-screen mt-2">
                        <div className="appointment-container">
                            <div className="mb-7 flex justify-between px-4">
                                <div className="flex w-full max-w-md items-center overflow-hidden rounded border border-gray-300">
                                    ...
                                    <input
                                        ...
                                        className="w-full border-none px-2 py-2 text-sm outline-none focus:border-none focus:outline-none focus:ring-0"
                                    />
                                    <button
                                        className="save-button flex h-full items-center justify-center rounded bg-[#429ABF] p-2 pl-3 pr-4"
                                        onClick={() =>
                                            handleSearch({
                                ...
                                <div className="flex gap-2">
                                    <NavLink
                                        href={route("allpatients.create")}
                                        active
                                        className="bg-gar-blue save-button btn flex items-center gap-1 px-2 py-1"
                                        style={{ height: "40px" }}
                                    >
                                        <svg
                                            width="12"
                                    ...
                                    <NavLink
                                        href={route("appointments.closed")}
                                        active
                                        className="bg-gar-blue save-button btn flex items-end gap-1 px-2 py-1"
                                        style={{ height: "40px" }}
                                    >
                                        Closed Appointments
                                    </NavLink>
                            ...
                            <div className="appointment-grid px-4">
                                <div className="grid-header">
                                    ...
                                    <div className="grid-cell ml-[4rem]">
                                        STATUS
                                    </div>
                                    <div className="grid-cell ml-[4rem]">
                                        ACTIONS
                                ...
                                <DragDropContext onDragEnd={onDragEnd}>
                                    ...
                                    >
                                        {(provided) => (
                                            <div
                                                className="grid-body main-screen-all-patients"
                                                        ...
                                                        >
                                                            {(
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="grid-cell">
                                                                        <div
                                                                            className={`queue-cell ${appointment.queue_type.toLowerCase() === "s" ? "type-s" : ""}`}
                                                                        >
                                                                            {
                                                                                appointment.queue_type
                                                                            }
                                                                            {
                                                                    ...
                                                                    <div className="grid-cell m-auto w-[70%]">
                                                                        <span
                                                                    ...
                                                                    >
                                                                        <div className="appmgr-action-dropdown">
                                                                            <button
                                                                                type="button"
                                                                                className="absolute bottom-0 top-[-14px] m-auto"
                                                                                onClick={(
                                                                                    e,
                                                                                ) =>
                                                                                    handleActionClick(
                                                                            ...
                                                                            {dropdownOpen ===
                                                                                appointment.id && (
                                                                                <div className="absolute left-7 text-right">
                                                                                    <div className="z-50 w-[70px] overflow-visible rounded-[8px] border border-gray-200 bg-white shadow-lg">
                                                                                        <button
                                                                                            type="button"
                                                                                            className="block w-full px-2 py-1 text-center text-[13px] text-gray-700 transition-colors hover:bg-[#CDCDCD]"
                                                                                            onClick={() => {
                                                                                                openEditModal(
                                                                                                    appointment,
                                                                                                );
                            ...
                            <div className="flex items-center border-t-[5px] border-[#E9F9FF] bg-white p-2">
                                <div className="absolute flex items-center px-5">
                                    <span className="font-light-blue mr-2 text-sm">
                                        Rows per page:
                                    </span>
                                    <select
                                        value={perPage}
                                ...
                                <div className="flex w-full justify-center">
                                    <div className="flex items-center space-x-2">
                                        <button
                                            ...
                                            className={`flex items-center rounded px-2 py-1 ${!appointments?.prev_page_url ? "cursor-not-allowed text-gray-400" : "text-blue-600 hover:bg-blue-100"}`}
                                        >
                                        ...
                                        <span className="custom-text-color flex items-center px-1">
                                            Page{" "}
                                            {appointments?.current_page || 1} of{" "}
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center rounded px-2 py-1 ${!appointments?.next_page_url ? "cursor-not-allowed text-gray-400" : "text-blue-600 hover:bg-blue-100"}`}
                                        >
                                            <div className="custom-text-color flex items-center">
                                                <span className="mx-1">|</span>
                                                <span>Next</span>
            ...
            {isEditModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="w-[340px] max-w-full rounded-lg bg-white p-4 shadow-xl">
                        <div className="mb-4 flex items-center justify-between">
                            <h3 className="font-poppins text-[20px] font-bold text-[#429ABF]">
                                Update Status
                            </h3>
                            <button
                        ...
                        <form onSubmit={handleEdit}>
                            <div className="mb-8 ml-4 w-[130px]">
                                <label className="mb-1 block font-poppins text-[14px] font-bold text-[#429ABF]">
                                    Select Status
                                </label>
                                <select
                                    className="w-full rounded-md border border-gray-300 bg-white text-center text-[14px] text-[#666666] shadow-sm focus:border-gray-400 focus:ring-gray-400"
                                    value={data.status}
                                    onChange={(e) =>
                    ...
                    />
                            ...
                            <div className="mt-4 flex justify-end space-x-2">
                                <button
                                    type="button"
                                    className="cancel-button rounded-md bg-white px-4 py-2.5 font-poppins text-[12px] font-normal text-[#429ABF] hover:bg-[#429ABF] hover:text-white"
                                    onClick={() => setIsEditModalOpen(false)}
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    className="save-button rounded-md bg-[#429ABF] px-4 py-2.5 font-poppins text-[12px] font-normal text-white hover:bg-[#33859F]"
                                    disabled={processing}
                                >
                                    Update
                                </button>
