...
export default function Login({ status }) {
    ...
    return (
        <>
            ...
            <FlashMessage />
            <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(180deg, #92B1B9 0%, #7A9BA5 40%, #2281A9 100%)' , height:'100vh' }}>
                <div className="w-[580px] relative -mt-[150px]">
                    ...
                    <div className="bg-[#4B7C98]/20 backdrop-blur-lg rounded-3xl shadow-2xl p-16 pb-24 relative mt-2">
                            ...
                            <div className="relative flex justify-center">
                                <div className="relative w-[320px]">
                                    <input
                                        ...
                                        className="w-full h-12 bg-transparent backdrop-blur-sm border-2 border-[#FFFFFF] rounded-full px-6 text-white placeholder-white/80 focus:outline-none focus:border-white pl-10 text-center"
...
<path d="M8 0C9.06087 0 10.0783 0.421427 10.8284 1.17157C11.5786 1.92172 12 2.93913 12 4C12 5.06087 11.5786 6.07828 10.8284 6.82843C10.0783 7.57857 9.06087 8 8 8C6.93913 8 5.92172 7.57857 5.17157 6.82843C4.42143 6.07828 4 5.06087 4 4C4 2.93913 4.42143 1.92172 5.17157 1.17157C5.92172 0.421427 6.93913 0 8 0ZM8 10C12.42 10 16 11.79 16 14V16H0V14C0 11.79 3.58 10 8 10Z" fill="white"/>
                            ...
                            <div className="flex justify-center">
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="w-[320px] h-12 bg-transparent hover:bg-white/10 backdrop-blur-sm border-2 border-[#FFFFFF] text-white font-medium rounded-full transition-colors duration-200 focus:outline-none focus:border-white text-center"
                                >
                                    LOGIN
                                </button>
                            </div>
