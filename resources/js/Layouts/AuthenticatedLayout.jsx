...
export default function Authenticated({ authh, header, children }) {
    ...
    return (
        <>
            <header className="bg-accent relative mt-4 flex items-center justify-between py-4 pr-4 sm:justify-normal sm:pr-8">
                <Link
                    href="/dashboard"
                    className="bg-accent absolute top-1/2 flex h-[93px] -translate-y-1/2 items-center justify-center overflow-hidden rounded-r-3xl border-2 border-l-0 border-white"
                >
                    <ApplicationLogo />
                </Link>
                <div className="w-60" />
                <ul className="mx-auto hidden items-center gap-4 text-sm text-white sm:flex xl:ml-0">
                    {navLinks.map((navLink) => (
                        <li key={navLink.id}>
                            <Link
                                href={navLink.href}
                                className={`flex items-center gap-2 rounded-md p-2 duration-200 xl:px-4 ${linkIsActive(navLink.href) ? "text-accent bg-white" : "hover:bg-white/10"}`}
                            >
                                <img
                                    src={
                ...
                <div className="flex items-center gap-2">
                    <div className="">
                        ...
                        <p className="text-accent-orange text-[10px]">
                    ...
                    <img
                        ...
                        height={45}
                        width={45}
                        className="border-accent-orange rounded-full border-2"
                    />
                </div>
            </header>
            <main>{children}</main>
