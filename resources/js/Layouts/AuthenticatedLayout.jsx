...
export default function Authenticated({ authh, header, children }) {
        ...
        <div className="min-h-screen mt-6">
            <nav className="border-b border-gray-100">
                <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 bg-white rounded-[10px]">
    ...
    active={
    route().current("dashboard") || route().current("home")
  }
    className="nav-item flex items-center gap-2 px-3 py-1 btn"
>
    <svg
        width="14"
        height="15"
    ...
    <span>Dashboard</span>
                                ...
                                <NavLink
                                    ...
                                    className="nav-item flex items-center gap-2 px-2 py-1 btn"
                                    activeClassName=""
                                >
                                    <svg
                                        width="24"
    ...
    <div
        className={`group nav-item relative p-1 inline-flex items-center cursor-pointer pl-4 pr-3 medical_records w-48 ${
            route().current("medicalrecords.*") || route().current("allpatients")  ? "nav-item-active" : "nav-item"
        }`}
    >
        <svg
            width="15"
        ...
        <ul className="absolute left-1/2 z-[99] -translate-x-1/2 top-full hidden group-hover:block bg-white shadow-md rounded-md list-disc text-sm text-gray-700 w-48">
            <li>
                <NavLink
                    href={route("medicalrecords.unfinisheddocs")}
                    active={route().current("medicalrecords.unfinisheddocs")}
                    className="medicallist block w-full px-3 py-2 hover:bg-[#429ABF] hover:text-white transition-colors duration-150 "
                    activeClassName="bg-[#429ABF] text-white"
                >
                    <span className="w-48 block">Unfinished Docs</span>
                </NavLink>
            </li>
            <li>
                <NavLink
                    ...
                    className="medicallist2 block w-full px-3 mt-0 py-2 hover:bg-[#429ABF] hover:text-white transition-colors duration-150 "
                    activeClassName="bg-[#429ABF] text-white"
                >
                    <span className="w-48 block">All Patients Records</span>
                </NavLink>
            </li>
        </ul>
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 text-right active:bg-transparent focus:outline-none"
                                            >
                                                {capitalize(auth?.user?.first_name)}  {capitalize(auth?.user?.last_name)} &nbsp;&nbsp;{" "}
                                                <br /> {capitalize(auth?.user?.role)} &nbsp;&nbsp;
                                                <svg
                                                    width="25"
                                                    height="25"
                                                    viewBox="0 0 25 25"
                ...
                >
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            <ResponsiveNavLink href={route("medication-templates")}>  
                                            Settings
                            </ResponsiveNavLink>
