...
export default function PatientSummaryPanel({ patient, setPatient }) {
        ...
        <div className="grid gap-4 rounded-lg bg-[#FAFAFA] p-2 shadow sm:grid-cols-2 lg:flex">
            ...
            <div className="flex flex-col divide-y-2 divide-accent-200 rounded-lg bg-white text-sm shadow-md">
                ...
                <div className="flex flex-1 flex-col justify-center gap-2 p-4">
                    <button className="rounded-md bg-accent px-3 py-2 text-xs font-medium text-white duration-100 hover:bg-accent/90">
                        SIGN AND CLOSE FORM
                    </button>
