...
export default function DeleteServiceModal({
    ...
    function handleDeleteService() {
        deleteRequest(route("service-charges.destroy", serviceToDelete?.id), {
            onSuccess: () => {
                closeModal();
            },
            onError: () => {
                toast.error("An error occurred deleting service");
            },
            // preserveState: true,
            preserveScroll: true,
        });
        ...
        <ModalContainer closeModal={closeDeleteModal} open={open}>
            ...
            >
                <div className="flex items-center justify-between p-2 px-4 pr-2">
                    <h5 className="font-semibold">Delete Service</h5>
                    <button
